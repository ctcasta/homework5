...
format:
  pdf:
    output-file: "homework5sub3camilacastaneda"
    output-ext:  "pdf"
    header-includes:
      - \usepackage{float}
...
Here is a link to my repository: {https://github.com/ctcasta/homework5}
...
load("/Users/camilacastaneda/Downloads/Econ-470/homework5/submission3/results/Homework5sub3workspace.RData")
```
